#+STARTUP: overview
#+TITLE: Scarlet ~ Witchmacs
#+LANGUAGE: en
#+OPTIONS: num:nil
+The cutest+ Another *Ufufufu* Emacs distribution

[[./gnuflan.png]]
* Introduction
Scarlet ~ Witchmacs is a very simple and basic configuration file for Emacs. From here you can edit, remove, or add many aspects of Emacs you want. I encourage you to do so, because Emacs works best when it's customized to your own liking!
* Why would I use this?
#+BEGIN_QUOTE
What's the difference between a villain and a super villain? Presentation!
#+END_QUOTE
Currently, the appeal of Scarlet ~ Witchmacs is +seeing a cute Marisa picture everytime you start up Emacs+ /Ufufufu/. Also, it is a very basic config which means you can easily add, edit or remove things as you like. You can use this as a building block when making your OWN Emacs config!
...
#+END_QUOTE
As opposed to many other Emacs distributions, Scarlet ~ Witchmacs has ZERO customization layers which means you can just jump in, look at the config file and start editing away! After all, Emacs works best when it's customized to your own liking!
* Quick install
#+BEGIN_SRC 
git clone https://github.com/feydor/scarlet-witchmacs ~/.emacs.d
#+END_SRC
...
*** Description
I prefer powerline over spaceline
*** Code
#+BEGIN_SRC emacs-lisp
...
*** Description
The frontend of Scarlet ~ Witchmacs; without this there'd be no +Marisa+ Flan in your Emacs startup screen
*** Code
#+BEGIN_SRC emacs-lisp
  (use-package dashboard
    ...
    (setq dashboard-banner-logo-title "S C A R L E T ~ W I T C H M A C S - The cutest Emacs distribution!")
...
#+END_SRC
*** Notes
If you pay close attention to the code in dashboard, you'll  notice that it uses custom functions defined under the :preface use-package block. I wrote all of those functions by looking at other people's Emacs distributions (Mainly [[https://github.com/seagle0128/.emacs.d][Centaur Emacs]]) and then experimenting and adapting them to Scarlet ~ Witchmacs. If you dig around, you'll find the same things I did - maybe even more!
*** Historical
...
*** Description
Vim keybindings in Emacs. Please note that Scarlet ~ Witchmacs has NO other evil-mode compatibility packages because I like to KISS. This might change in the future
*** Code
#+BEGIN_SRC emacs-lisp
  (use-package evil
    :ensure t
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package yasnippet-snippets
    :ensure t)
#+END_SRC
** C & [['https://harmful.cat-v.org/software/c++/I_did_it_for_you_all'][C++]]
*** Description
